...
namespace lve {
	...
	static void framebufferResizeCallback(GLFWwindow* window, int width, int height) {
		...
		//auto app2 = reinterpret_cast<LveWindow*>(glfwGetWindowUserPointer(window));
	...
	void FirstApp::createLogicalDevice()
	{
		...
		for (int queueFamily : uniqueQueueFamilies) {
			...
			queueCreateInfo.pQueuePriorities = &queueProiority;
	...
	void FirstApp::createBuffer(VkDeviceSize size, VkBufferUsageFlags usage, VkMemoryPropertyFlags propertices, VkBuffer& buffer, VkDeviceMemory& bufferMemory)
	{
	...
	void FirstApp::createCommandBuffers()
	{
		...
		for (size_t i = 0; i < commandBuffers.size(); i++)
		{
			...
			vkCmdSetViewport(commandBuffers[i], 0, 1, vps);
			VkRect2D rs[1] = { {{0,0},{WIDTH,HEIGHT}} };
			vkCmdSetScissor(commandBuffers[i], 0, 1, rs);
